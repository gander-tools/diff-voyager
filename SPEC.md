...
- V28: ∀ db access in worker.ts & cli.ts → routed thru repo interfaces; ⊥ raw db.prepare(...)/.exec(...) outside src/repos/*.ts; verify via grep -rn "\.prepare(" src/ excluding src/repos/ → 0 hits
