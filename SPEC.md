...
| T36 | .      | tests: `RunsRepo` — findOpenRun (→ RunRecord), insertRunWithUrlRuns (tx), updatePid, markAbandoned/markDone/markDoneWithErrors; real temp-file SQLite                                                                                                                                                                                                                                                   | V2,V8,V9,V11,V12,V16,V32 |
| T37 | .      | `src/repos/runsRepo.ts` — `RunsRepo` interface + `DrizzleRunsRepo` impl                                                                                                                                                                                                                                                                                                                                 | V2,V8,V9,V11,V12,V16,V32 |
