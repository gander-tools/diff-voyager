...
import { PageStatus, type SeoData, type PerformanceData } from '@gander-tools/diff-voyager-shared';
...
export class SnapshotRepository {
  ...
  private rowToEntity(row: SnapshotRow): SnapshotEntity {
    return {
      ...
      performanceData: row.performance_data_json ? JSON.parse(row.performance_data_json) : undefined,
