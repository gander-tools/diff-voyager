...
describe('UrlNormalizer', () => {
  describe('normalize', () => {
    ...
    it('should remove tracking parameters', () => {
      expect(UrlNormalizer.normalize('https://example.com/page?utm_source=test&id=1')).toBe('/page?id=1');
    });
    ...
    it('should handle multiple tracking params', () => {
      expect(UrlNormalizer.normalize('https://example.com/page?utm_source=a&utm_medium=b&real=value')).toBe('/page?real=value');
    });
  ...
  describe('isSameDomain', () => {
    it('should return true for same domain', () => {
      expect(UrlNormalizer.isSameDomain('https://example.com', 'https://example.com/page')).toBe(true);
    });

    it('should return false for different domain', () => {
      expect(UrlNormalizer.isSameDomain('https://example.com', 'https://other.com/page')).toBe(false);
    });

    it('should handle subdomains as different', () => {
      expect(UrlNormalizer.isSameDomain('https://example.com', 'https://sub.example.com/page')).toBe(false);
    });
  });
});
