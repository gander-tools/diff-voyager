...
export function createRunStatistics(overrides: Partial<RunStatistics> = {}): RunStatistics {
  return {
    totalPages: 0,
    completedPages: 0,
    errorPages: 0,
...
export function createViewport(overrides: Partial<ViewportConfig> = {}): ViewportConfig {
  return {
    width: 1920,
    height: 1080,
    ...overrides,
